        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-warn-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href="{{ url('super-user/complaints/new') }}">
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-add-card"> 
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href="{{ url('super-user/complaints/solved') }}">
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i class="bi bi-file-spreadsheet"></i>
                </div>
                <div class="ps-3">
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-view-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href="{{ url('super-user/complaints/all') }}">
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i class="bi bi-file-spreadsheet"></i>
                </div>
                <div class="ps-3">
