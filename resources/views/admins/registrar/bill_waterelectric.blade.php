  ...
  <h1>Registrar</h1>
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href={{ url('registrar/fee/card')}}>Fees Details</a></li>
        <li class="breadcrumb-item active">Water&amp;Electricity Bills</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Water Electricity Bills</h5>
            @if(is_Null($bills))
