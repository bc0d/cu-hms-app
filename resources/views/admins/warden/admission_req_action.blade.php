...
@section('content')
    ...
    <div class="pagetitle">
      <h1>Student Admission Aproval</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href={{ url('warden/index') }}>Home</a></li>
          <li class="breadcrumb-item"><a href={{ url('warden/admission/request') }}>Admission Request</a></li>
          <li class="breadcrumb-item active">Admission Aproval</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card">
                <div class="card-body pt-3">
                  ...
                  <div class="tab-pane profile-edit pt-3" id="profile-edit">
                    ...
                    <form action="{{ route('warden.admission.approve') }}" method="POST" class="mt-5">
                      @csrf
                      <div class="row mb-3">
