        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-add-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('warden/admission/request') }}>
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-rmv-card"> 
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('warden/vacate/request') }}>
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-view-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('warden/fee/maintanance') }}>
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i class="bi bi-file-spreadsheet"></i>
                </div>
                <div class="ps-3">
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-warn-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('warden/rules/card') }}>
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-warn-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('warden/complaints/card') }}>
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-warn-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('warden/request-admin') }}>
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i class="bi bi-person-exclamation"></i>
                </div>
                <div class="ps-3">
