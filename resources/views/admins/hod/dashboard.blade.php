        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-add-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('hod-request-allocation')}}>
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-rmv-card"> 
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('hod-request-vacating')}}>
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-xxl-6 col-md-6">
          <div class="card info-card req-view-card">
            <div class="card-body">
              ...
              <a class="d-flex align-items-center" href={{ url('hod-students-list') }}>
                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
