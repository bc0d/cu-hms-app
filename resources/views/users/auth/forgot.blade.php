...
<body>
    <main id="main">
        <section id="contact" class="contact">
            <h2 class="sign-sec  text-center">Forgot Password</h2><hr>
            <div class="container">
                @if (session('message'))
                ...
                <div class="row justify-content-center center-sign">   
                    <div class="col-lg-8  mt-2 mt-lg-0 pt-2 pt-3">
                        <form action="{{ route('generate.password.link') }}" method="POST" class="php-email-form">
                            @csrf
                            <p>
                                Enter your registered email id to sent link.
                            </p>
