...
<section class="section-50">
    <div class="container">
        ...
        <h3 class="m-b-50 heading-line d-flex flex-column align-items-center">
        Notifications
            ...
            <div class="notification-list">
                <div class="notification-list_content">
                    ...
                    <div class="notification-list_detail">
                        <p><b>Brian Cumin</b></p>
                        <p class="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Unde, dolorem.</p>
                        <p class="text-muted"><small>30 mins ago</small></p>
                    </div>
                </div>
            ...
            <div class="notification-list">
                <div class="notification-list_content">
                    ...
                    <div class="notification-list_detail">
                        ...
                        <p class="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Unde, dolorem.</p>
                        <p class="text-muted"><small>50 mins ago</small></p>
                    </div>
                </div>
        ...
        <div class="text-center">
            <a href="#!" class="dark-link">Load more notifications</a>
        </div>
