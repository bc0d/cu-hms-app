...
<head>
  ...
  <link href="{{ asset('users/assets/css/profile.css') }}" rel="stylesheet">
</head>
<body>
        ...
        <div class="row gy-4">
            ...
            <div class="card widget-card border-light shadow-sm">
              ...
              <div class="card-body">
                <div class="text-center mb-3">
                  <img src="{{ asset("/./assets/img/profile-img-1.jpg") }}" class="img-fluid rounded-circle" alt="Luna John">
                </div>
          ...
          <div class="col-12">
            <div class="card widget-card border-light shadow-sm">
              ...
              <div class="card-body">
                <a href="{{ url("#!") }}" class="d-inline-block bg-dark link-light lh-1 p-2 rounded">
                ...
                <form action="#!" class="row gy-3 gy-xxl-4">
                  <div class="col-12">
                    <div class="row gy-2">
                      ...
                      <div class="col-12">
                        <img src="{{ asset("/./assets/img/profile-img-1.jpg") }}" class="img-fluid" alt="Luna John">
                      </div>
                      <div class="col-12">
                        <a href="{{ url("#!") }}" class="d-inline-block bg-primary link-light lh-1 p-2 rounded">
                          <i class="bi bi-upload"></i>
                        </a>
                        <a href="{{ url("#!") }}" class="d-inline-block bg-danger link-light lh-1 p-2 rounded">
