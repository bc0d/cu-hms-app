...
class FeeAndPaymentRegistrarController extends Controller
{
    ...
    public function showBills() {
        ...
        return view('admins.registrar.bills_card', compact('admin'));
    }
    ...
    public function roomRentDetails() {
        ...
        return view('admins.registrar.bill_room', compact('admin', 'rents'));
    }
    ...
    public function waterElectricBills() {
        ...
        return view('admins.registrar.bill_waterelectric', compact('admin', 'bills'));
    }
    ...
    public function feeMaintanance() {
        ...
        return view('admins.registrar.fee_maintanance', compact('admin', 'fees'));
    }

    public function showFeeAdd() {
        $admin = Auth::guard('admins')->user();
        return view('admins.registrar.fee_add',compact('admin'));
    }
    ...
    public function showFeeEdit($id) {
        ...
        return view('admins.registrar.fee_edit', compact('admin', 'fee'));
    }
