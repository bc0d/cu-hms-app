...
class RuleAndNoticeAdminController extends Controller
{
    ...
    public function viewRules() {
        $admin = Auth::guard('admins')->user();
        $rules = Rule::all();
        return view('admins.superUser.rules_list', compact('admin','rules'));
    }
    ...
    public function viewNotices() {
        $admin = Auth::guard('admins')->user();
        $notices = Notice::all();
        return view('admins.superUser.notice_list',compact('admin','notices'));
    }

    public function viewAddNotice() {
        $admin = Auth::guard('admins')->user();
        return view('admins.superUser.notice_add',compact('admin'));
    }
    ...
    public function addNotice(Request $request) {
        ...
        return redirect('super-user/rules/notice-list');
