...
class FeeAndPaymentAdminController extends Controller
{
    ...
    public function showBills() {
        ...
        return view('admins.superUser.bills_card', compact('admin'));
    }
    ...
    public function roomRentDetails() {
        ...
        return view('admins.superUser.bill_room', compact('admin', 'rents'));
    }
    ...
    public function waterElectricBills() {
        ...
        return view('admins.superUser.bill_waterelectric', compact('admin', 'bills'));
    }
    ...
    public function feeMaintanance() {
        ...
        return view('admins.superUser.fee_maintanance', compact('admin', 'fees'));
    }

    public function showFeeAdd() {
        $admin = Auth::guard('admins')->user();
        return view('admins.superUser.fee_add',compact('admin'));
    }
    ...
    public function showFeeEdit($id) {
        ...
        return view('admins.superUser.fee_edit', compact('admin', 'fee'));
    }
